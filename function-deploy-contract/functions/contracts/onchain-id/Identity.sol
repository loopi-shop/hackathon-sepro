...
contract Identity is Storage, IIdentity, Version {
    ...
    {
        // console.log("getKey", toHex32String(_key));
        // console.log("getKey", toHex32String(_keys[_key].key));
    ...
    function keyHasPurpose(
        ...
        // console.log("keyHasPurpose begin", _purpose);
        // console.log("_key", _key);
        Key memory key = _keys[_key];
        // Key memory key = getKey(_key);
        // console.log("_key", _key);
        // getKey2(_key);
        // console.log(toHex32String(_key));
        // console.log(toHex32String(key.key));
        // console.log("keyHasPurpose", !(key.key == 0));
        ...
        for (
            ...
            // console.log("(purpose == 1 || purpose == _purpose)", (purpose == 1 || purpose == _purpose));
